...
### TUI 重设计 v1.1.1 完成（4 GAP 真用户验证收口）

**TUI 重设计 v1 完成**（commit `7bd43ef`）
- DAG 3 行盒子 + Activity Stream 双行 entry + 32 EventType 字段级映射
- **1380 passed 0 回归**，mxint 真跑 tape 重放 SVG 截屏

**TUI 重设计 v1.1.1 真用户验证 4 GAP 收口**（commit `225933e`）
- GAP-A/B/C/E surgical fix + 8 新测试 + 真 TUI 重放脚本
- **1392 passed 0 回归**
