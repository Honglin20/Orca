...
# current, every round's proposals.json for the idle probe, the frozen origin
# anchor); the knobs are the round cap and the idle-round cap (workflow
# inputs). Before deciding, the deployed script set's version stamp is
