...
> String-path concatenation and file existence checks are handled deterministically by
> `check_flatten.sh` / `check_expand.sh` / `check_train_script.sh` — out of scope here. This verifier
