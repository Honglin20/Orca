#!/usr/bin/env python3
"""Create a portable Web dashboard snapshot for a profiling-v2 workspace (v6 §4.2).
...
<html lang="en"><head><meta charset="utf-8"><title>profiling-v2 dashboard</title>
...
<script type="application/json" id="profiling-v2-data">{payload}</script></body></html>
"""
